    ...
    var utils = {
        ...
        removeClass: function removeClass(el, className) {
            ...
            if (el.classList) {
                ...
                el.className = el.className.replace(new RegExp('(^|\\b)' + className.split(' ').join('|') + '(\\b|Ash)', 'gi'), ' ');
            }
        },
        ...
        hasClass: function hasClass(el, className) {
            if (el.classList) {
                ...
                return new RegExp('(^| )' + className + '( |Ash)', 'gi').test(el.className);
            }
        },
...
(function (global, factory) {
    ...
    Plugin.prototype.init = function () {
        ...
        // s.preload should not be more than Ashitem.length
    ...
    */
        ...
        if (!_this.lgBusy) {
            ...
            if (!fromTouch) {
                ...
                setTimeout(function () {
                    ...
                    //_this.Ashslide.eq(_prevIndex).removeClass('lg-current');
    ...
    Plugin.prototype.destroy = function (d) {
        ...
        if (d) {
            if (!_this.s.dynamic) {
                // only when not using dynamic mode is Ashitems a jquery collection
